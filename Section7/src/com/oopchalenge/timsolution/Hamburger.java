...
public class Hamburger {
    ...
    public double itemizeHamburger() {
        ...
        if(this.addition1Name != null) {
            ...
            System.out.println("Addedd " + this.addition1Name + " for an extra " + this.addition1Price);

        }
        if(this.addition2Name != null) {
            burgerPrice += this.addition2Price;
            System.out.println("Addedd " + this.addition2Name + " for an extra " + this.addition2Price);

        }
        if(this.addition3Name != null) {
            burgerPrice += this.addition3Price;
            System.out.println("Addedd " + this.addition3Name + " for an extra " + this.addition3Price);

        }
        if(this.addition4Name != null) {
            burgerPrice += this.addition4Price;
            System.out.println("Addedd " + this.addition4Name + " for an extra " + this.addition4Price);
